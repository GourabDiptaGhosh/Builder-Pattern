...
public class HTTPRequest {
    ...
    private final Map<String, String> m_headers, m_queryParams;
    ...
    private HTTPRequest(/*String url, String body, HttpMethod method, int timeout, boolean redirects,
                        Map<String, String> headers, Map<String, String> queryParams*/Builder builder) {
        m_url = builder.m_url;
        m_method = builder.m_method;
        m_headers = Map.copyOf(builder.m_headers);
        m_queryParams = Map.copyOf(builder.m_queryParams);
        m_body = builder.m_body;
        m_timeout = builder.m_timeout;
        m_redirects = builder.m_redirects;
    }
